...
export const PERMISSIONS = {
  ...
  // 11. Factory Job Costing & Rate Cards
  COSTING_RATE_VIEW: 'costing:rate:view',
  COSTING_RATE_MANAGE: 'costing:rate:manage',
  COSTING_JOB_VIEW: 'costing:job:view',
  COSTING_JOB_CALCULATE: 'costing:job:calculate',
  COSTING_JOB_FREEZE: 'costing:job:freeze',
  COSTING_REPORT_VIEW: 'costing:report:view',

  // 12. Factory Billing & Accounts Receivable
  BILLING_INVOICE_CREATE: 'billing:invoice:create',
  BILLING_INVOICE_VIEW: 'billing:invoice:view',
  BILLING_INVOICE_FINALIZE: 'billing:invoice:finalize',
  BILLING_INVOICE_VOID: 'billing:invoice:void',
  BILLING_PAYMENT_RECORD: 'billing:payment:record',
  BILLING_AGING_VIEW: 'billing:aging:view',

  // 13. Factory Analytics & Reporting
  ...
  // 14. Platform & Tenant Administration
...
export const DEFAULT_FACTORY_ROLES = [
  ...
  },
  {
    ...
    permissions: [
      ...
      PERMISSIONS.COSTING_RATE_MANAGE,
      PERMISSIONS.COSTING_JOB_VIEW,
      PERMISSIONS.COSTING_JOB_CALCULATE,
      PERMISSIONS.COSTING_JOB_FREEZE,
      PERMISSIONS.COSTING_REPORT_VIEW,
      PERMISSIONS.BILLING_INVOICE_CREATE,
      PERMISSIONS.BILLING_INVOICE_VIEW,
      PERMISSIONS.BILLING_INVOICE_FINALIZE,
      PERMISSIONS.BILLING_INVOICE_VOID,
