...
export const PERMISSIONS = {
  ...
  // 7b. Authoritative Creation Phase (PO -> Storage -> GRN -> Units)
  PURCHASE_ORDER_CREATE: 'purchase_order:order:create',
  PURCHASE_ORDER_VIEW: 'purchase_order:order:view',
  PURCHASE_ORDER_UPDATE: 'purchase_order:order:update',
  INVENTORY_STORAGE_RECORD: 'inventory:storage:record',
  INVENTORY_GRN_CREATE: 'inventory:grn:create',
  INVENTORY_GRN_VIEW: 'inventory:grn:view',
  INVENTORY_GRN_PRINT: 'inventory:grn:print',
  ...
  DISPATCH_CHALLAN_PRINT: 'dispatch:challan:print',
  ...
  // 14. Factory Alerting & Notifications
  NOTIFICATION_VIEW: 'notification:feed:view',
  NOTIFICATION_MANAGE: 'notification:feed:manage',
  NOTIFICATION_PREFERENCES_UPDATE: 'notification:preferences:update',
  NOTIFICATION_BROADCAST: 'notification:alert:broadcast',

  // 15. Platform & Tenant Administration
